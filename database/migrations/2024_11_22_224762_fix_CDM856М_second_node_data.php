    ...
    public function up(): void
    {
        DB::transaction(function () {
            ...
            foreach ($equipmentIds as $equipmentId) {
                ...
                DB::table('components')
                    ->where('name', 'Замена насоса гидравлического сдвоенныого')
                    ->where('vendor_code', '31LH-60070')
                    ->where('amount', 3)
                    ->where('node_id', $nodeId)
                    ->delete();
